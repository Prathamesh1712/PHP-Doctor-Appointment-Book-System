...
$q="select * from reg where username=' ".$username." ' ";
...
$rq="UPDATE `reg` SET fname='$_POST[fname]' ,lname='$_POST[lname]',adde='$_POST[adde]',mno='$_POST[mno]' where username='$_POST[username]'    ";
