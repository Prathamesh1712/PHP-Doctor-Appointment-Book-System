...
<p> <input type="text" name="setid"  placeholder="Enter First Name" value="<?php echo $row['username']?>" readonly/></p>
<p> <input type="text" name="setdate"  placeholder="Enter First Name" value="<?php echo $row['sess']?>" readonly/></p>
